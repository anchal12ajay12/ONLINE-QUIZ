...
<div class='w3-container top'>
 ...
 <div id="top" style="float:left;padding-right:10px;margin-right:auto;"> 	
  	<p> Time Remaining: <span id="countdowntimer">10 </span> Seconds</p>
</div>		
...
try {
			...
			//PreparedStatement ps = con.prepareStatement("select * from addques where lang='C'");
			PreparedStatement ps = con.prepareStatement("select * from ( select * from addques where lang='C' order by dbms_random.value ) where rownum <= 5 ");
